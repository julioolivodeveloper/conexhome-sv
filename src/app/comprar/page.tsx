...
export const metadata: Metadata = {
  ...
  description: 'Encuentra casas, apartamentos, terrenos y más propiedades en venta en El Salvador.',
}
...
export default async function BuyPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <div className="bg-navy py-8 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-4 text-slate-300 text-sm">
            ...
            <span>·</span>
            <Link href="/alquilar" className="hover:text-white transition-colors underline underline-offset-2">
              Ver en alquiler
            </Link>
            <span>·</span>
      ...
      {/* Filters */}
      <SearchFiltersPanel lockedOperation="venta" totalResults={total ?? 0} />
