...
export const metadata: Metadata = {
  ...
  description:
    'Encuentra casas y apartamentos en alquiler en El Salvador.',
}

export default function RentPage() {
  const alquileres = recentProperties.filter((p) => p.operation === 'alquiler')
      ...
      <div className="bg-navy py-10 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-slate-300 text-sm">
            {alquileres.length} propiedades disponibles · Filtros y mapa disponibles en Etapa 4
          </p>
        </div>
      </div>
